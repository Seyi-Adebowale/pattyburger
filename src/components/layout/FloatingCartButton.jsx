        ...
        <AnimatePresence>
          {count > 0 && (
            <motion.span
              ...
              className="absolute -right-1 -top-1 grid h-[22px] min-w-[22px] place-items-center rounded-full bg-accent-400 px-1 text-[11px] font-bold text-ink ring-2 ring-white sm:h-6 sm:min-w-6 sm:text-xs"
            >
              {count}
            </motion.span>
          )}
